...
- [深入浅出Typescript](#%E6%B7%B1%E5%85%A5%E6%B5%85%E5%87%BAtypescript)
  ...
  - [Reflect Metadata](#reflect-metadata)
    ...
    - [常用方法](#%E5%B8%B8%E7%94%A8%E6%96%B9%E6%B3%95)
      - [设置/获取元数据](#%E8%AE%BE%E7%BD%AE%E8%8E%B7%E5%8F%96%E5%85%83%E6%95%B0%E6%8D%AE)
      - [内置元数据](#%E5%86%85%E7%BD%AE%E5%85%83%E6%95%B0%E6%8D%AE)
    - [实践工作](#%E5%AE%9E%E8%B7%B5%E5%B7%A5%E4%BD%9C)
  - [赋值断言、is 关键字、可调用类型注解和类型推导](#%E8%B5%8B%E5%80%BC%E6%96%AD%E8%A8%80is-%E5%85%B3%E9%94%AE%E5%AD%97%E5%8F%AF%E8%B0%83%E7%94%A8%E7%B1%BB%E5%9E%8B%E6%B3%A8%E8%A7%A3%E5%92%8C%E7%B1%BB%E5%9E%8B%E6%8E%A8%E5%AF%BC)
    - [明确赋值断言](#%E6%98%8E%E7%A1%AE%E8%B5%8B%E5%80%BC%E6%96%AD%E8%A8%80)
    - [is 关键字](#is-%E5%85%B3%E9%94%AE%E5%AD%97)
    - [可调用类型注解](#%E5%8F%AF%E8%B0%83%E7%94%A8%E7%B1%BB%E5%9E%8B%E6%B3%A8%E8%A7%A3)
...
看完这些`API`的命名其实有经验的开发者已经可以猜出来这些`API`的大概作用了，我们后面会提及，而且这些API接受的参数一共就四种，我们在这里说明一下:

- `Metadata Key`: 元数据的`Key`，本质上内部实现是一个`Map`对象，以键值对的形式储存元数据
- `Metadata Value`: 元数据的`Value`，这个容易理解
...
比如在 `Node.j`s 中有一些框架，比如 `Nestjs` 会有分散式的装饰器路由，比如 `@Get` `@Post` 等，正是借助 `Reflect Metadata` 实现的。
...
到这里为止我们已经可以向`Class`中添加各种必要的元数据了，但是我们还差一步，就是读取元数据。
...
- 该属性本来就可以是 `undefined`，这种情况下添加类型`undefined`
...
此时我们可以看到，`greeter`函数自动加上了返回值类型，这是 `TypeScript` 自带的类型推导。
